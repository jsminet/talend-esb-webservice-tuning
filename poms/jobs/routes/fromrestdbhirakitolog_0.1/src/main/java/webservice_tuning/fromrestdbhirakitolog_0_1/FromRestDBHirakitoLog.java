...
package webservice_tuning.fromrestdbhirakitolog_0_1;
...
/**
 * Job: FromRestDBHirakitoLog Purpose: <br>
 * Description: <br>
 * 
...
public class FromRestDBHirakitoLog extends
	...
	public void setArguments(Object arguments) {
		this.inOSGi = true;
		FromRestDBHirakitoLog.arguments = arguments;
	...
	public void doConfig() throws java.lang.Exception {
		...
		from(
				inOSGi || inMS ? "cxfrs://"
						...
						+ "?resourceClasses=webservice_tuning.fromrestdbhirakitolog_0_1.FromRestDBHirakitoLog$Service_cREST_1"
						...
						+ "&bindingStyle=SimpleConsumer" + "&synchronous="
						+ true
						: "cxfrs://"
								+ "http://127.0.0.1:8040/customer"
								+ "?resourceClasses=webservice_tuning.fromrestdbhirakitolog_0_1.FromRestDBHirakitoLog$Service_cREST_1"
				...
				.routeId("FromRestDBHirakitoLog_cREST_1")
				.setBody()
				.constant("SELECT * FROM CUSTOMERS WHERE ID = :?id")
				.id("FromRestDBHirakitoLog_cSetBody_2")
				.to("jdbc:myDatasource?useHeadersAsParameters=true")
				.id("FromRestDBHirakitoLog_cMessagingEndpoint_4")
				.to("dataformat:json-jackson:marshal?useList=true&unmarshalTypeName=beans.Customer&prettyPrint=true")
				.id("FromRestDBHirakitoLog_cMessagingEndpoint_3");
	}
			...
			protected CamelContext createContext() {
				final org.apache.camel.impl.DefaultCamelContext camelContext = new org.apache.camel.spring.SpringCamelContext(
						new org.springframework.context.support.ClassPathXmlApplicationContext(
								"META-INF/spring/fromrestdbhirakitolog.xml"));
				camelContext.setName("FromRestDBHirakitoLog");
				// add notifier
				...
				runStat.setAllPID(pid, pid, pid, "FromRestDBHirakitoLog");
				try {
				...
				targetNodeToConnectionMap.put(
						"FromRestDBHirakitoLog_cMessagingEndpoint_3", "route9");
				targetNodeToConnectionMap.put(
						"FromRestDBHirakitoLog_cMessagingEndpoint_4", "route7");
				targetNodeToConnectionMap.put(
						"FromRestDBHirakitoLog_cSetBody_2", "route1");
	...
	public static void main(String[] args) {
		int exitCode = new FromRestDBHirakitoLog().runJobInTOS(args);
		if (exitCode != 0) {
	...
	private void readContextValues(String contextName) {
		...
		try {
			java.io.InputStream inContext = FromRestDBHirakitoLog.class
					.getClassLoader().getResourceAsStream(
							"webservice_tuning/fromrestdbhirakitolog_0_1/contexts/"
