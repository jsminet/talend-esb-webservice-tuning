...
package webservice_tuning.fromrestdbcachingtolog_0_1;
...
/**
 * Job: FromRestDBCachingtoLog Purpose: <br>
 * Description: <br>
 * 
...
public class FromRestDBCachingtoLog extends
	...
	public void setArguments(Object arguments) {
		this.inOSGi = true;
		FromRestDBCachingtoLog.arguments = arguments;
	...
	public void doConfig() throws java.lang.Exception {
				...
				});
		{
			...
			ds.setJdbcUrl("jdbc:h2:tcp://localhost/~/testtalend;IFEXISTS=TRUE");
			ds.setUsername("sa");
			ds.setPassword("");
		...
		from("direct:ehcache")
				.routeId("FromRestDBCachingtoLog_cDirect_1")
				.to("ehcache:dataServiceCache?configurationUri=classpath:ehcache2.xml&keyType=java.lang.String&valueType=java.lang.String")
				.id("FromRestDBCachingtoLog_cMessagingEndpoint_1");

		from(
				inOSGi || inMS ? "cxfrs://"
						+ "http://127.0.0.1:8040/customer"
						+ "?resourceClasses=webservice_tuning.fromrestdbcachingtolog_0_1.FromRestDBCachingtoLog$Service_cREST_1"
				...
				.routeId("FromRestDBCachingtoLog_cREST_1")
				.setHeader("CamelEhcacheAction")
				.constant("GET")
				.setHeader("CamelEhcacheKey")
				.header("id")
				.id("FromRestDBCachingtoLog_cSetHeader_3")
				.to("direct:ehcache")
				.id("FromRestDBCachingtoLog_cDirect_2")
				.choice()
				.id("FromRestDBCachingtoLog_cMessageRouter_1")
				.when()
				.simple("${header.CamelEhcacheActionHasResult} == false")
				.setBody()
				.constant("SELECT * FROM CUSTOMERS WHERE ID = :?id")
				.id("FromRestDBCachingtoLog_cSetBody_2")
				.to("jdbc:myDatasource?useHeadersAsParameters=true")
				.id("FromRestDBCachingtoLog_cMessagingEndpoint_4")
				.to("dataformat:json-jackson:marshal?useList=true&unmarshalTypeName=beans.Customer&prettyPrint=true")
				.id("FromRestDBCachingtoLog_cMessagingEndpoint_3")
				.setHeader("CamelEhcacheAction").constant("PUT")
				.setHeader("CamelEhcacheKey").header("id")
				.setHeader("CamelEhcacheValue").simple("${body}")
				.id("FromRestDBCachingtoLog_cSetHeader_4").to("direct:ehcache")
				.id("FromRestDBCachingtoLog_cDirect_4").when()
				.simple("${header.CamelEhcacheActionHasResult} == true")
				.setHeader("CamelEhcacheAction").constant("GET")
				.setHeader("CamelEhcacheKey").header("id")
				.id("FromRestDBCachingtoLog_cSetHeader_5").to("direct:ehcache")
				.id("FromRestDBCachingtoLog_cDirect_3");
	}
			...
			protected CamelContext createContext() {
				final org.apache.camel.impl.DefaultCamelContext camelContext = new org.apache.camel.spring.SpringCamelContext(
						new org.springframework.context.support.ClassPathXmlApplicationContext(
								"META-INF/spring/fromrestdbcachingtolog.xml"));
				camelContext.setName("FromRestDBCachingtoLog");
				// add notifier
				...
				runStat.setAllPID(pid, pid, pid, "FromRestDBCachingtoLog");
				try {
				...
				targetNodeToConnectionMap
						.put("FromRestDBCachingtoLog_cMessagingEndpoint_1",
								"route1");
				targetNodeToConnectionMap.put(
						"FromRestDBCachingtoLog_cDirect_2", "route2");
				targetNodeToConnectionMap.put(
						"FromRestDBCachingtoLog_cMessageRouter_1", "route3");
				targetNodeToConnectionMap.put(
						"FromRestDBCachingtoLog_cSetBody_2", "when1");
				targetNodeToConnectionMap
						.put("FromRestDBCachingtoLog_cMessagingEndpoint_4",
								"route7");
				targetNodeToConnectionMap
						.put("FromRestDBCachingtoLog_cMessagingEndpoint_3",
								"route9");
				targetNodeToConnectionMap.put(
						"FromRestDBCachingtoLog_cSetHeader_4", "route10");
				targetNodeToConnectionMap.put(
						"FromRestDBCachingtoLog_cDirect_4", "route22");
				targetNodeToConnectionMap.put(
						"FromRestDBCachingtoLog_cSetHeader_5", "when2");
				targetNodeToConnectionMap.put(
						"FromRestDBCachingtoLog_cDirect_3", "route20");
				targetNodeToConnectionMap.put(
						"FromRestDBCachingtoLog_cSetHeader_3", "route8");
	...
	public static void main(String[] args) {
		int exitCode = new FromRestDBCachingtoLog().runJobInTOS(args);
		if (exitCode != 0) {
	...
	private void readContextValues(String contextName) {
		...
		try {
			java.io.InputStream inContext = FromRestDBCachingtoLog.class
					.getClassLoader().getResourceAsStream(
							"webservice_tuning/fromrestdbcachingtolog_0_1/contexts/"
